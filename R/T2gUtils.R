...
#' @param corMethod the method of calculating correlation. Supported
#'   methods are 'pearson' (default), 'spearman', or 'kendall'. See
#'   ?stats::cor for more details.
#' @param useMethod what observations should be used? Supported options
#'   are "everything" (default), "all.obs", "complete.obs", "na.or.complete",
#'   or "pairwise.complete.obs". See ?stats::cor for more details on what
#'   each option entails.
#'
#' @return an 'ff' object pointing to a file on disk containing the
